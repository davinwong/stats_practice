classdef Classifier
    ...
    methods
        ...
        %initializes classifier, as well as construct sample data
        ...
        %calculates eigen value/vectors, as well as tilt angle
    ...
    methods (Static = true)
        ...
        %applies mu and sigma transform to randn matrix
        function A = gaussTransform(in, mu, Sigma)
            R = chol(Sigma);
            A = repmat(mu',length(in),1)+in*R;
        end
        
        %calculates MED distance
        ...
        %helper function to plot bounded graphs
